...
public class SimuladorDOM extends JFrame {
    ...
    private void aplicarTemaVerde() {
        Color verdeClaro = new Color(210, 255, 220);
        Color verdeMedio = new Color(70, 180, 110);
        Color verdeOscuro = new Color(0, 100, 40);
        ...
        UIManager.put("Panel.background", verdeClaro);
        UIManager.put("Label.foreground", verdeOscuro);
        UIManager.put("Label.font", new Font("Georgia", Font.BOLD, 14));

        UIManager.put("TextArea.background", Color.WHITE);
        UIManager.put("TextArea.foreground", Color.DARK_GRAY);
        UIManager.put("TextArea.border", BorderFactory.createLineBorder(verdeOscuro));

        UIManager.put("ComboBox.background", verdeMedio);
        UIManager.put("ComboBox.foreground", Color.WHITE);

        UIManager.put("Tree.background", Color.WHITE);
        UIManager.put("Tree.selectionBackground", verdeMedio);
    }
    ...
    private void configurarLayout() {
        ...
        lblInfo.setForeground(new Color(0, 100, 40));
        panelInfo.add(lblInfo);
        add(panelInfo, BorderLayout.NORTH);
    }

    // ------------------------------
    //  LÓGICA (queda exactamente igual)
    // ------------------------------
