...
public class Arbol extends JFrame {
    ...
    private void configurarVentana() {
        setTitle("Árbol Binario de Búsqueda - Rey");
        setSize(1300, 750);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLocationRelativeTo(null);

        // FONDO VERDE MUY SUAVE
        getContentPane().setBackground(Color.decode("#C8F7C5"));
    }
    ...
    private void inicializarComponentes() {
        ...
        txtValor.setBorder(BorderFactory.createLineBorder(Color.decode("#66BB6A"), 2));

        txtResultado = new JTextArea(9, 35);
        txtResultado.setEditable(false);
        txtResultado.setFont(new Font("Consolas", Font.PLAIN, 15));
        txtResultado.setBackground(Color.decode("#1565C0"));
    ...
    private void configurarLayout() {
        ...
        panelSuperior.setBackground(Color.decode("#90CAF9")); // Azul suave
        ...
        panelInferior.setBackground(Color.decode("#C8F7C5"));

        JPanel panelRecorridos = new JPanel(new FlowLayout());
        panelRecorridos.setBackground(Color.decode("#C8F7C5"));
        ...
        panelPruebas.setBackground(Color.decode("#C8F7C5"));
        ...
        panelTexto.setBackground(Color.decode("#C8F7C5"));
    ...
    private JButton crearBoton(String texto) {
        ...
        b.setBackground(Color.decode("#26A69A"));  // verde–turquesa
        b.setForeground(Color.WHITE);
        b.setFont(new Font("Segoe UI", Font.BOLD, 14));
        b.setBorder(BorderFactory.createLineBorder(Color.decode("#1565C0"), 2));

        b.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseEntered(MouseEvent e) {
                b.setBackground(Color.decode("#1565C0")); // azul oscuro
            }
            @Override
            public void mouseExited(MouseEvent e) {
                b.setBackground(Color.decode("#26A69A"));
            }
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new Arbol().setVisible(true));
    }
}
